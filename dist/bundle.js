// [DozArtworkPlayer]  Build version: 1.1.3  
...
function register() {
    if (typeof window !== 'undefined') {
        ...
        (0, _doz.createDozWebComponent)('doz-artwork-player', _src2.default, ['image-url', 'audio-url', 'border-radius']);
    }
}
...
var _class = function (_Component) {
    ...
    _createClass(_class, [{
        ...
        value: function template(h) {
            return h(_templateObject, this.props.width, this.props.height, this.props.imageUrl, this.props.borderRadius, this.toggle, !!this.props.audioUrl, _playSvg2.default, this.props._state === STATE.PAUSE, _pauseSvg2.default, this.props._state === STATE.PLAY, this.props._progress);
        }
    }, {
        key: 'toggle',
